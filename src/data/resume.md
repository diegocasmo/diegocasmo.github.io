...
Panama & Remote (Mar 2014 - Jul 2017)

- Full‑stack engineer working independently and with teams across [PhoneTradr](https://www.phonetradr.com/), [Torak’s Kanban Zone](https://kanbanzone.com/), and [X-Team](https://x-team.com/) (for [Protocol Labs](https://protocol.ai/) via [CoinList](https://coinlist.co/)) from 2016 to 2017. Worked on everything from performance improvements and feature development to test automation and architecture refactors.
- Before that, contributed to B2B web apps in logistics and digital media at [Mod Op](https://www.linkedin.com/company/modop/) and [Ubiqua](https://www.linkedin.com/company/ubiquame/posts/?feedView=all) in Panama (2014 to 2016).
...
- **Languages:** TypeScript, Elixir, Ruby
...
- [Simple Next.js Magic Link JWT Authentication with Prisma, PostgreSQL, and Resend](https://diegocasmo.github.io/simple-nextjs-magic-link-jwt-authentication-with-prisma-postgresql-and-resend/)
- [Onboarding as an Engineer in the Age of AI](https://diegocasmo.github.io/onboarding-as-an-engineer-in-the-age-of-ai/)
- [Intent-First Software](https://diegocasmo.github.io/intent-first-software/)
- [Reducing Type Overhead with Lazy Evaluation in TypeScript](https://diegocasmo.github.io/reducing-type-overhead-with-lazy-evaluation-in-typescript/)
