...
pubDate: 2025-08-05
description: "Improving TypeScript type-checker performance by using lazy evaluation to reduce type overhead."
...
This change meant TypeScript would only resolve the types for the specific path we passed in. Since our [internal hooks](https://diegocasmo.github.io/api-using-axios-react-query/) already received a path as a parameter, updating the generic definition was all it took to reduce the load.
