...
import AlgoViz from '../../components/animations/AlgoViz.astro';
import MergeSort from '../../components/animations/MergeSort.astro';
...
<AlgoViz title="Splitting: Divide Phase" id="ms-split" duration={5800}>
  <MergeSort step={1} />
</AlgoViz>

- Recursively sort each half

<AlgoViz title="Comparing: How Merge Works" id="ms-compare" duration={7200}>
  <MergeSort step={2} />
</AlgoViz>

- Merge the two sorted arrays

<AlgoViz title="Merging: Combining Two Sorted Halves" id="ms-merge" duration={8800}>
  <MergeSort step={3} />
</AlgoViz>
...
<AlgoViz title="Full Merge Sort: End-to-End" id="ms-full" duration={7800}>
  <MergeSort step={4} />
</AlgoViz>
