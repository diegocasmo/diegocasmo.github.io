...
pubDate: 2021-08-29
description: "Setting up Expo and Firebase for email/password authentication — project initialization and configuration."
...
- This is part 1/3 of a series of blog posts that showcase email and password based authentication using Expo and Firebase.
  ...
  - [Part 2: Sign Up, Email Verification, and Sign Out](https://diegocasmo.github.io/email-and-password-based-authentication-with-expo-and-firebase-part-2-sign-up-email-verification-and-sign-out/)
  - [Part 3: Sign In, Forgot Password, and Update Password](https://diegocasmo.github.io/email-and-password-based-authentication-with-expo-and-firebase-part-3-sign-in-forgot-password-and-update-password/)
